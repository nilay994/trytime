// Source: https://github.com/AscendNTNU/msp_flightcontroller_interface
...
class MSP {
    ...
    std::map<unsigned char, std::function<void(Payload)>>callback_table;
